---
aliases: [tutorial_pages/resources.html]
---
...
* CSV dataset generated in Example 1, which is also used later in Example 2: `novel-question-output.csv`.  
* CSV dataset used in Example 3: `mediation-raw-data.csv`.
