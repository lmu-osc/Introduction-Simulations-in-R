...
6. **Analyse and interpret the combined results of many simulation repetitions** within each set of parameters. For instance, check that you only get a significant result in 5% of the simulation repetitions (if `alpha = 0.05`) when you simulated no effect and that you get a significant result in 80% of the simulation repetitions (if you targeted a power of 80%) when you simulated an effect.  
