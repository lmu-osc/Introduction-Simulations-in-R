...
***p*-values of *t*-tests comparing means from 20 or 100 simulation repetitions of N(0,1) with n = 10:**   
<br/>
<img src="../assets/ttest-changing-nrep.png" width="500">  
<br/>


In the first case, where the number of repetitions `nrep = 20`, we expect 1 out of the 20 tests to be significant (5%). In my case, I did! How many did you get?    
In the second case, where number of repetitions `nrep = 100`, we expect 5 out of the 100 tests to be significant. In my case, I got 6. How many did you get?      
...
***p*-values of *t*-tests comparing means from 1000 simulation repetitions of N(0,1) with n=10 or n=100:**   
<br/>
