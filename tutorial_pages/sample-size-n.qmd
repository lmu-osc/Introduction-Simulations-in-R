...
**1 simulation repetiton of N(0,1) with n = 10:**  
...
**24 simulation repetitions of N(0,1) with n = 10:**  
<br/>
...
How are the means and standard deviations of the 24 simulation repetitions distributed?  

**Distributions of the means and SDs from 24 simulation repetitions of N(0,1) with n = 10:**  
<br/>
...
**24 simulation repetitions of the same distribution, i.e. N(0,1), with n = 1000:**  
<br/>
<img src="../assets/24hist1000N01.png" width="600">  
<br/>

**Distributions of the means and SDs from 24 simulation repetitions of N(0,1) with n = 1000:**  
<br/>
